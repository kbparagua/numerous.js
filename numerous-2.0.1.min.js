...
$(document).ready(function(a){Numerous={};Numerous.init=function(a){var b=$(".numerous");Numerous.addFormHash={};Numerous.options=a;for(var c=0,d=b.length;c<d;c++){var e=$(b[c]),f=e.attr("id"),g=f.replace(/fields-for-/,""),h="add-to-"+g,i="#"+g;e.removeClass("numerous").attr("id","");var j=$("<div></div>").append(e);Numerous.addFormHash[h]={form:j.html(),"fields-for":f,"update-div":i};e.remove();Numerous.clickHandlerForAdd(h);Numerous.createHandlersForRemove(f)}};Numerous.clickHandlerForAdd=function(a){var b="#"+a;$(b).click(function(a){a.preventDefault();var b=Numerous.addFormHash[this.id],c=(new Date).getTime(),d=b["form"].replace(/replace_this/g,c);d=$(d);d.addClass(b["fields-for"]);$(b["update-div"]).append(d);var e=Numerous.options[b["fields-for"]];if(e){var f=e["add"];if(f){f(d)}}})};Numerous.createHandlersForRemove=function(a){var b="."+a+" .numerous-remove a";$("body").off("click",b);$("body").on("click",b,function(b){b.preventDefault();var c=$(this),d=c.parent().parent();c.siblings("input").attr("value","1");d.hide();var e=Numerous.options[a];if(e){var f=e["remove"];if(f){f(d)}}})}})
